...
let AuthenticationApiService = class AuthenticationApiService {
    constructor(http) {
        this.http = http;
    }
    login(user) {
...
AuthenticationApiService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
AuthenticationApiService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
UserApiService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: "root",
    })
], UserApiService);
