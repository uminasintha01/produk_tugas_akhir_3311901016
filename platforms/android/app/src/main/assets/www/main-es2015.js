...
const routes = [
    ...
    },
    {
        path: 'landing',
        canActivate: [_guards_authentication_guard__WEBPACK_IMPORTED_MODULE_3__["AuthenticationGuard"]],
        loadChildren: () => __webpack_require__.e(/*! import() | pages-landing-landing-routing-module */ "pages-landing-landing-routing-module").then(__webpack_require__.bind(null, /*! ./pages/landing/landing-routing.module */ "./src/app/pages/landing/landing-routing.module.ts")).then(m => m.LandingRoutingModule)
    },
    {
        path: 'login',
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | pages-forgot-password-forgot-password-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-forgot-password-forgot-password-module")]).then(__webpack_require__.bind(null, /*! ./pages/forgot-password/forgot-password.module */ "./src/app/pages/forgot-password/forgot-password.module.ts")).then(m => m.ForgotPasswordPageModule)
    },
    {
        path: 'intro',
...
/* harmony import */ var _ionic_native_unique_device_id_ngx__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ionic-native/unique-device-id/ngx */ "./node_modules/@ionic-native/unique-device-id/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_uid_ngx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-native/uid/ngx */ "./node_modules/@ionic-native/uid/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_extended_device_information_ngx__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic-native/extended-device-information/ngx */ "./node_modules/@ionic-native/extended-device-information/__ivy_ngcc__/ngx/index.js");
...
/* harmony import */ var _ionic_native_device_ngx__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ionic-native/device/ngx */ "./node_modules/@ionic-native/device/__ivy_ngcc__/ngx/index.js");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _ionic_native_extended_device_information_ngx__WEBPACK_IMPORTED_MODULE_11__["ExtendedDeviceInformation"],
...
const apiUrl = "http://192.168.56.1:8000/api/";
...
let AuthenticationService = class AuthenticationService {
    ...
    sendResetEmail(token, AuthenticationApiService) {
        throw new Error('Method not implemented.');
    }
    login(token) {
        return this.storage.set(_config_api__WEBPACK_IMPORTED_MODULE_4__["tokenKey"], token).then((res) => {
            this.authenticationState.next(true);
        });
    }
    logout() {
        return this.storage.remove(_config_api__WEBPACK_IMPORTED_MODULE_4__["tokenKey"]).then((res) => {
    ...
    checkToken() {
        return this.storage.get(_config_api__WEBPACK_IMPORTED_MODULE_4__["tokenKey"]).then((res) => {
            if (res) {
                this.authenticationState.next(true);
            }
        });
...
module.exports = __webpack_require__(/*! C:\Users\hp\Downloads\zfix-trade-in-2022-master\src\main.ts */"./src/main.ts");
